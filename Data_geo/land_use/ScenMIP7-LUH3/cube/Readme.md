...
Metric : 
- Land cover type — fraction (0-1) of the grid cell occupied by each land cover class.
...
Metric : 
- Allocation of harvested biomass — fraction of harvested wood biomass carbon allocated to each forestry use type (rndwd, fulwd, combf, pltns_bfuel, pltns_wdprd). Units: Fraction (0-1)
